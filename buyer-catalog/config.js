// ── Bake It More — buyer catalog configuration ───────────────────────────
// Fill in API_KEY once you have it from Google Cloud Console
// (APIs & Services → Credentials → Create Credentials → API key).
// Both files below must be shared as "Anyone with the link — Viewer" in
